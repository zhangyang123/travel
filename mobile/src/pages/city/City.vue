...
<script>
    ...
    export default {
       ...
       methods:{
          getCityInfo () {
             //axios.get("/api/city.json").then(this.handleGetCitySuccInfo)
             this.handleGetCitySuccInfo();
          },
          handleGetCitySuccInfo () {
             
             if(this.cityData.ret && this.cityData.list) {
                 this.hotCities = this.cityData.list.hotCities;
                 this.cities = this.cityData.list.cities;
             }
          }
